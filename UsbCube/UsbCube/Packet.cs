...
namespace Alpine.Device
{
    public class MobileDevice
    {
        ...
        public bool Connect()
        {
            ...
            {
                if (!ReferenceEquals((mDevice = UsbDevice.OpenUsbDevice(new UsbDeviceFinder(mVendor, 0x7523))), null))
                {
                    //write debug log "OK"
                    return true;
                }
